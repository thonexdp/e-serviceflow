...
export default function DeliveryReceipt({ data = {} }) {
    ...
    const rowCount = Math.max(6, data.items?.length || 0);
    ...
    return (
        <div className="delivery-receipt-container bg-white text-black" style={{
            ...
            height: '209mm', // Reduced to prevent blank 2nd page
            padding: '10mm 20mm', // Increased horizontal padding
            ...
            {/* Dotted Separator */}
            <div style={{ borderTop: '4px dotted #000', width: '100%', marginBottom: '20px' }}></div>
